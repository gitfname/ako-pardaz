...
import { ArrowLeftSolidIcon, CancelIconSquare, DocumentIcon, EditIcon, Icon123, LayersIconSquare, MailIcon, PeopleIcon, PersonalIcon, PhoneIcon, PlusIcon, SearchIcon, ShoppingCarIconSquare, UserIconSquare } from "./icons";
